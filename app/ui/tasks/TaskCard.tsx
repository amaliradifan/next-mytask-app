...
export default function TaskCard({ task }: { task: Task }) {
	const openModal = (id: any) => {
		const modalDetail = document.getElementById(id) as HTMLDialogElement;
		if (modalDetail) {
	...
	return (
		<>
			<div
				...
				className="card max max-w-72 mb-8 bg-base-100 shadow-xl mx-4 h-60 hover:border-warning 
                hover:scale-110 transition duration-300 ease-in-out flex-grow hover:cursor-pointer"
			>
